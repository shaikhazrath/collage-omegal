...
<h5 className="font-medium md:text-4xl text-sm text-gray-600 ">Video chat is comesoon...</h5>
<div>

<button
  className="text-white bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-orange-300  shadow-lg shadow-orange-500/50 font-bold rounded-md text-xl px-5 py-2.5 text-center me-2 mb-2 animate-bounce  mt-5  "
